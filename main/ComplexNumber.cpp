	...
	: Real(Input1), Imaginary(Input2), Magnitude(Input1), Argument(Input2)
{
	...
	else std::cout << "Warning: Invalid ComplexNumber Form!" << std::endl;
}
...
void ComplexNumber::SetReal(float input) { Real = input;  SetPolarForm(); }
void ComplexNumber::SetImaginary(float input) { Imaginary = input;  SetPolarForm(); }
void ComplexNumber::SetMagnitude(float input) { Magnitude = input;  SetCartesianForm(); }
void ComplexNumber::SetArgument(float input) { Argument = input;  SetCartesianForm(); }
